...
const Nelex = (props) => {
  ...
  useEffect(() => {
    ...
    // axios.get("http://live.nelexnigeria.com/api/nelex-lmis-data")
    //   .then((response) => {
                    ...
                    <div className="card-body">
                      <div className="rt-single-icon-box">
                        ...
                        <div className="iconbox-content">
                          <div className="f-size-24 ft-wt-5"><span className="counter">{data?.jobsCount}</span>
                          </div>
                  ...
                  <div className="card jobcardStyle1 counterbox tw-bg-white hover:tw-shadow-[0px_12px_48px_rgb(2,131,79,0.9)]">
                    <div className="card-body">
                      <div className="rt-single-icon-box">
                        ...
                        <div className="iconbox-content">
                          <div className="f-size-24 ft-wt-5"><span className="counter">{data?.companiesCount}</span>
                          </div>
                  ...
                  <div className="card jobcardStyle1 counterbox tw-bg-white hover:tw-shadow-[0px_12px_48px_rgb(2,131,79,0.9)]">
                    <div className="card-body">
                      <div className="rt-single-icon-box">
                        ...
                        <div className="iconbox-content">
                          <div className="f-size-24 ft-wt-5"><span className="counter">{data?.candidatesCount}</span>
                          </div>
                  ...
                  <div className="card jobcardStyle1 counterbox tw-bg-white hover:tw-shadow-[0px_12px_48px_rgb(2,131,79,0.9)]">
                    <div className="card-body">
                      <div className="rt-single-icon-box">
                        ...
                        <div className="iconbox-content">
                          <div className="f-size-24 ft-wt-5"><span className="counter">{data?.PEAsCount}</span>
                          </div>
                ...
                <div className="row">
                  {
                    ...
                    Object.values(data?.popularCategories).map((item, index) => (
                      <div key={index} className="col-lg-3 col-md-6 col-sm-6">
                        <div className="most-popular-wrap">
                          <div className="most-popular-item">
                            <h6>{item.name}
                            </h6>
                            <p>{item.jobs?.length} Jobs</p>
                          </div>
                        </div>
                      </div>
                    ))
